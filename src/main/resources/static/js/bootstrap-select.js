  ...
  var Selectpicker = function (element, options) {
    ...
    this.selectpicker = {
      main: {
        ...
        // allows us to do
		// this.main.elements[this.selectpicker.main.map.newIndex[index]] to
		// select an element based on the originalIndex
        map: {
          newIndex: {},
          originalIndex: {}
        }
  ...
  Selectpicker.prototype = {
    ...
    createView: function (isSearching, scrollTop) {
      ...
      function scroll(scrollTop, init) {
        ...
        if (isVirtual === true) {
          // if an option that is encountered that is wider than the current
			// menu width, update the menu width accordingly
    ...
    createLi: function () {
      var that = this,
          ...
          liIndex = -1; // increment liIndex whenever a new <li> element is
						// created to ensure newIndex is correct
      ...
      if (this.options.title && !this.multiple) {
        ...
        // since newIndex is recalculated on every refresh, liIndex needs to be
      ...
      $selectOptions.each(function (index) {
        ...
        if (isOptgroup && thisData.divider !== true) {
          ...
          if (!this.previousElementSibling) { // Is it the first option of the
												// optgroup?
            optID += 1;
            ...
            if (index !== 0 && mainElements.length > 0) { // Is it NOT the
															// first option of
															// the select && are
															// there elements in
															// the dropdown?
    ...
    render: function () {
      ...
      // If this is a multiselect, and selectedTextFormat is count, then show
		// 1 of 2 selected etc..
    ...
    setOptionStatus: function () {
      ...
      if (that.selectpicker.view.visibleElements && that.selectpicker.view.visibleElements.length) {
        for (var i = 0; i < that.selectpicker.view.visibleElements.length; i++) {
          var index = that.selectpicker.current.map.originalIndex[i + that.selectpicker.view.position0], // faster
																											// than
    ...
    changeAll: function (status) {
      ...
      for (var i = 0; i < this.selectpicker.current.elements.length; i++) {
        var liData = this.selectpicker.current.data[i],
            index = this.selectpicker.current.map.originalIndex[i], // faster
																	// than
																	// $(li).data('originalIndex')
            option = $selectOptions[index];
    ...
    keydown: function (e) {
      ...
      if (isArrowKey) { // if up or down
        ...
        // $items.index/.filter is too slow with a large list and no virtual
		// scroll

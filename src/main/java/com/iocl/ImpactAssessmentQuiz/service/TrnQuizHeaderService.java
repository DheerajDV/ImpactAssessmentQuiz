...
public class TrnQuizHeaderService {
	...
	public List<TrnQuizHeaderModel> findDivQuizListForResetCompCode(Long emp_code, String div_code,
			List<String> allowed_comp_code) {
		return trnQuizHeaderRepository.findDivQuizListForResetCompCode(emp_code, div_code, allowed_comp_code);
	}
